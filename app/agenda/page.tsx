...
export default function AgendaPage() {
  const timeline = [
    { date: 'September - November 2025', event: 'Conference Announcement / Call for Papers', status: 'upcoming' },
    { date: 'November 30, 2025', event: 'Full Paper Submission Deadline', status: 'important' },
    { date: 'December 15, 2025', event: 'Late Submission / Extended Deadline', status: 'important' },
    { date: 'December 2025 - January 2026', event: 'Review Period', status: 'upcoming' },
    { date: 'January 31, 2026', event: 'Acceptance Notification', status: 'important' },
    { date: 'February 15, 2026', event: 'Camera-Ready Paper Submission', status: 'important' },
    { date: 'February 20, 2026', event: 'Author Registration Deadline', status: 'important' },
  ...
  const schedule = [
    {
      ...
      sessions: [
        ...
        { time: '10:30 - 11:00', title: 'Tea Break & Networking' },
